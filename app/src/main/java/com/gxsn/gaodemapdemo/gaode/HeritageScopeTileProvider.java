...
public class HeritageScopeTileProvider extends UrlTileProvider {
    ...
    public HeritageScopeTileProvider() {
        ...
        //地址写你自己的wms地址
        mRootUrl = "http://121.36.72.93:8080/geoserver/guyiliang//wms?LAYERS=guyiliang%3A20200620_yixian_zs_r&FORMAT=image%2Fpng&TRANSPARENT=TRUE&SERVICE=WMS&VERSION=1.1.1&REQUEST=GetMap&STYLES=&SRS=EPSG%3A4326&BBOX=";
    }
